  ...
  return (
    <div className="container mx-auto p-5 relative">
      ...
      <div className="relative">
        ...
        {/* Image */}
        <img src={heroImage} alt="Hero" className="w-full h-auto max-sm:h-[400px] object-cover" />
        {/* Text Content */}
        <div className="absolute inset-0 flex flex-col gap-4 items-center justify-center">
          <h1 className="text-[#f6f6f4] font-urbanist text-4xl sm:text-5xl lg:text-6xl font-semibold text-center px-4">
            Your Legal Partner for a Brighter Future
          </h1>
          <p className="text-[#f6f6f4] font-urbanist sm:w-[80%] lg:w-[600px] text-center px-4">
        ...
        {/* Search Bar */}
        <div className="absolute justify-center flex w-full bottom-[-10%] max-sm:top-[90%] px-4">
          <div className="w-full max-w-4xl px-6 py-4 flex flex-col lg:flex-row justify-between gap-4 lg:gap-8 rounded-full max-sm:rounded-[0px] bg-white items-center shadow-lg">
